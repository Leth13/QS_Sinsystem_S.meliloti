...
%Warning: long simulation for a large sample of data
...
mu =      Parameters_From_File(5); %min^-1 - growth rate - Bettenworth 
...
epsilon_sinr = Parameters_From_File(14); % min^-1  - SinR degradation - Bettenworth
rho = Parameters_From_File(15); % min^-1  - AHL_o degradation - Buceta
